...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors muled transactions for new ipfs metadata via zmq.
...
* Run muled or mule-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:29652```
