...
"""
    ...
    Mule should be started with the command line arguments:
        muled -testnet -daemon \
                -zmqpubhashblock=tcp://127.0.0.1:29652 \
                -zmqpubrawtx=tcp://127.0.0.1:29652 \
                -zmqpubhashtx=tcp://127.0.0.1:29652 \
                -zmqpubhashblock=tcp://127.0.0.1:29652
"""
...
print("Getting Mulecoin msgs")
socket.connect("tcp://localhost:29652")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND MLDC issuance at " + str(pos))
				print("After MLDC: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND MLDC something at " + str(pos))
			start += pos+8
			print(astr)
