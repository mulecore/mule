...
#ifndef MULECOIN_ASSET_PROTOCOL_H
#define MULECOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_MULE_ASSET MLDCQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_MULE_ASSET MLDCO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_MULE_ASSET MLDCR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_MULE_ASSET MLDCT
...
#endif //MULECOIN_ASSET_PROTOCOL_H
