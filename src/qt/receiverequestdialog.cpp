...
#include "config/mule-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMuleURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MuleUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMuleURI(info));
}
