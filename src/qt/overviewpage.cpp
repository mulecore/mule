...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(MuleUnits::MLDC),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MuleUnits::formatWithUnit(unit, balance, false, MuleUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MuleUnits::formatWithUnit(unit, unconfirmedBalance, false, MuleUnits::separatorAlways));
    ui->labelImmature->setText(MuleUnits::formatWithUnit(unit, immatureBalance, false, MuleUnits::separatorAlways));
    ui->labelTotal->setText(MuleUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, MuleUnits::separatorAlways));
    ui->labelWatchAvailable->setText(MuleUnits::formatWithUnit(unit, watchOnlyBalance, false, MuleUnits::separatorAlways));
    ui->labelWatchPending->setText(MuleUnits::formatWithUnit(unit, watchUnconfBalance, false, MuleUnits::separatorAlways));
    ui->labelWatchImmature->setText(MuleUnits::formatWithUnit(unit, watchImmatureBalance, false, MuleUnits::separatorAlways));
    ui->labelWatchTotal->setText(MuleUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, MuleUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("MLDC")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the MLDC balance grid from expanding and looking terrible when asset balance is hidden
