...
#ifndef MULE_QT_MULEGUI_H
#define MULE_QT_MULEGUI_H
...
/**
  Mule GUI main class. This class represents the main window of the Mule UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MuleGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MuleGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MuleGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a mule wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
