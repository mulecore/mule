...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MuleAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_mule-qt -platform xcb      # Linux
//     src/qt/test/test_mule-qt -platform windows  # Windows
//     src/qt/test/test_mule-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MuleUnits::formatWithUnit(unit, balance, false, MuleUnits::separatorAlways);
    ...
    // Amount input
    MuleAmountField* amountInput = receiveCoinsDialog.findChild<MuleAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: mule:")) != -1);
