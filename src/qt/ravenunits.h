...
#ifndef MULE_QT_MULEUNITS_H
#define MULE_QT_MULEUNITS_H
...
/** Mule unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MuleUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MuleUnits(QObject *parent);

    /** Mule units.
      @note Source: https://en.mule.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MLDC,
...
typedef MuleUnits::Unit MuleUnit;

#endif // MULE_QT_MULEUNITS_H
