...
#ifndef MULE_QT_GUIUTIL_H
#define MULE_QT_GUIUTIL_H
...
/** Utility functions used by the Mule Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mule:" URI into recipient object, return true on successful parsing
