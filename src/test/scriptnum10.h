...
#ifndef MULE_TEST_SCRIPTNUM10_H
#define MULE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mule Core 0.10.0, for cross-comparison.
 */
public:
