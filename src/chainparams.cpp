...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nStartTime = 1616747081; // Oct 31, 2018
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nStartTime = 1616721092; // UTC: Mon Jan 13 2020 13:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nStartTime = 1616721071; // UTC: Wed May 06 2020 18:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nStartTime = 1616721057; // UTC: Mon Jun 29 2020 18:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nStartTime = 1616721039; // UTC: Thu Aug 13 2020 18:00:00
        ...
        genesis = CreateGenesisBlock(1616747081, 1350888, 0x1e00ffff, 4, 5000 * COIN);

        consensus.hashGenesisBlock = genesis.GetX16RHash();

        assert(consensus.hashGenesisBlock == uint256S("00000b415cf4a9cbd537bb0a9870e0bf61d2f7c30e22cbedfaf68b692d725530"));
        assert(genesis.hashMerkleRoot == uint256S("9de98de0a4ae10c978327414448c6b1ce12435a8d32dbc59e62d6dd2649b9bbf"));
        ...
        // Mule BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Mule chain
...
//        /////////////////////////////////////////////////////////////////
        ...
        vSeeds.emplace_back("seed-testnet-mule.bitactivate.com", false);
        vSeeds.emplace_back("seed-testnet-mule.mulecoin.com", false);
        vSeeds.emplace_back("seed-testnet-mule.mulecoin.org", false);
        ...
        // Mule BIP44 cointype in testnet
        nExtCoinType = 1;
...
//        /////////////////////////////////////////////////////////////////
        ...
        // Mule BIP44 cointype in regtest
        nExtCoinType = 1;
