...
#ifndef MULE_SCRIPT_STANDARD_H
#define MULE_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_MULE_ASSET script that carries data
    /** MLDC END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a mulecoin address
 */
...
/**
 * Generate a Mule scriptPubKey for the given CTxDestination. Returns a P2PKH
