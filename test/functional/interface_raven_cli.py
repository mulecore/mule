...
class TestMuleCli(MuleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `mule-cli getinfo`")
        ...
        self.log.info("Compare responses from `mule-cli -getinfo` and the RPCs data is retrieved from.")
