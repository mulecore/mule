...
class TxnMallTest(MuleTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 MLDC:
        ...
        # First: use raw transaction API to send 1240 MLDC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MLDC coin each
        ...
        # Node0's balance should be starting balance, plus 50MLDC for another
        ...
        # Node0's total balance should be starting balance, plus 100MLDC for 
