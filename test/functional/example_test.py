...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MuleTestFramework
    pass

class ExampleTest(MuleTestFramework):
    # Each functional test is a subclass of the MuleTestFramework class.
    ...
    def custom_method(self):
        ...
        MuleTestFramework class so other tests can use it."""
