...
By default, muled will dump mempool on shutdown and
...
class MempoolPersistTest(MuleTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give muled a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent muled from writing mempool.dat to disk. Verify that `savemempool` fails")
