...
class WalletTest(MuleTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MLDC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 MLDC with subtract fee from amount
        ...
        # Sendmany 10 MLDC with subtract fee from amount
