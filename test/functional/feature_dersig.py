...
class BIP66Test(MuleTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # muled is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and muled produces more specific reject
            # reasons.
