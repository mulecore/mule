...
import os
import struct
from test_framework.test_framework import MuleTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(MuleTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that mule has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("muled has not been built with zmq enabled.")
