...
# TestNode: A peer we use to send messages to muled, and store responses.
...
class CompactBlocksTest(MuleTestFramework):
    ...
    # This test actually causes muled to (reasonably!) disconnect us, so do this last.
    ...
    # Test that muled requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for muled to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # muled will not send blocktxn responses for blocks whose height is
