...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Mulecoin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like muled does for MLDC)
...
* Run a contest: MLDC prize for best idea for new Mulecoin based Business
...
* Back-end API platform for Mulecoin
    * Other people to hit high-availablity API
* Fee system to pay MLDC fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of MLDC for fees.
...
* #KYC tagger - store info and tag Mulecoin addresses
* #ACCREDITED - verify accredited status and tag Mulecoin addresses
 
### Technical Consultant
* Help companies apply Mulecoin capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional MLDC and asset support


### Areas for Mulecoin Innovation
* Financial
