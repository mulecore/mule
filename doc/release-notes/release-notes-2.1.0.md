Mule Core version *2.1.0* is now available!!
==============

  <https://github.com/MuleProject/Mulecoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/MuleProject/Mulecoin/commits/release_2.1.0>
